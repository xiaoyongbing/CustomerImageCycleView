package com.hdos.customerimagecycleview.view;
...
import com.hdos.customerimagecycleview.R;
...
public class ImageCycleView extends LinearLayout {
	...
	public ImageCycleView(Context context, AttributeSet attrs) {
		...
		tvNum = (TextView) findViewById(R.id.tv_page);
	 ...
	 */
	public void setImageResources(ArrayList<MainPic> infoList, ImageCycleViewListener imageCycleViewListener) {
		// 清除所有子视图
		mGroup.removeAllViews();
		// 图片广告数量
		final int imageCount = infoList==null?0:infoList.size();
	...
	private final class GuidePageChangeListener implements OnPageChangeListener {
		...
		public void onPageSelected(int index) {
			...
			// 设置图片滚动指示器背景
			mImageIndex = index;
			tvNum.setText(index+"/"+mImageViews.length);
			index -= 1;
	...
	private class ImageCycleAdapter extends PagerAdapter {
		 ...
		 * 图片资源列表
		 */
		private ArrayList<MainPic> mAdList = new ArrayList<MainPic>();
		...
		public ImageCycleAdapter(Context context, ArrayList<MainPic> adList, ImageCycleViewListener imageCycleViewListener) {
			mContext = context;
			mAdList = adList;
		...
		public Object instantiateItem(ViewGroup container, final int position) {
			String imageUrl = mAdList==null?"":mAdList.get(position).getImgUrl();
	...
	public static interface ImageCycleViewListener {
		 ...
		 * @param imageView
		 */
		public void onImageClick(MainPic info, int postion, View imageView);
	}
